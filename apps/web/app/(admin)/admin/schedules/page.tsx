                    ...
                    <CardContent className="space-y-5 p-5">
                      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_220px_auto]">
                        <div className="min-w-0 space-y-2">
                          ...
                          <p className="text-sm leading-6 text-muted-foreground">{schedule.request.address}</p>
                          <div className="grid gap-2 text-sm text-muted-foreground md:grid-cols-3">
                            <span>Resident: {schedule.request.user.name}</span>
                            <span>Assigned: {schedule.request.assignedTo?.name ?? "None"}</span>
                            <span>Collection: {formatDate(schedule.collectionDate)}</span>
                          </div>
                        </div>
